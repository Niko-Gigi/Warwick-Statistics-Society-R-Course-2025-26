...
The first step is always importing your data. For this tutorial, we will use the **Palmer Penguins** dataset, which contains size measurements for three penguin species living on islands in the Palmer Archipelago, Antarctica.
...
Using `head()` allows you to peek at the first few rows. This is a crucial habit; seeing the raw structure of your dataframe helps you spot potential relationships between variables like `flipper_length_mm` and `body_mass_g` before you even start plotting.
...
1. There is a positive linear relationship between flipper length and body mass.
2. Gentoo penguins (cyan) are distinctively larger than the other two species.
3. The relationship between size and mass appears consistent across species (similar slopes).

# 3. Advanced: Placing Mappings and Storing Objects
...
* **R for Data Science (2nd Ed):** The Data Visualization chapter is essential reading. [https://r4ds.hadley.nz/data-visualize](https://r4ds.hadley.nz/data-visualize)
* **The R Graph Gallery:** A collection of charts made with R to inspire your next visualization. [https://r-graph-gallery.com/](https://r-graph-gallery.com/)
